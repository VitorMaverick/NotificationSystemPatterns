...
import { ICliente, defaultValue } from 'app/shared/model/notificationSystem/cliente.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './cliente.reducer';
