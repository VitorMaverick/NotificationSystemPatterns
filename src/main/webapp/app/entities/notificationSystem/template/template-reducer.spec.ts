...
import { ITemplate, defaultValue } from 'app/shared/model/notificationSystem/template.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './template.reducer';
