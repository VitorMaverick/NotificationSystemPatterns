...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENSAGEMENVIADA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENSAGEMENVIADA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENSAGEMENVIADA actions', async () => {
      const arg = { id: 15420 };
    ...
    it('dispatches UPDATE_MENSAGEMENVIADA actions', async () => {
      const arg = { id: 15420 };
    ...
    it('dispatches PARTIAL_UPDATE_MENSAGEMENVIADA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENSAGEMENVIADA actions', async () => {
      const arg = 42666;
