...
import { ISegmento, defaultValue } from 'app/shared/model/notificationSystem/segmento.model';
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './segmento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEGMENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEGMENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEGMENTO actions', async () => {
      const arg = { id: 10362 };
    ...
    it('dispatches UPDATE_SEGMENTO actions', async () => {
      const arg = { id: 10362 };
    ...
    it('dispatches PARTIAL_UPDATE_SEGMENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEGMENTO actions', async () => {
      const arg = 42666;
