...
@AnalyzeClasses(packagesOf = NotificationSystemApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(NotificationSystemApp.class), alwaysTrue())
