...
public class TemplateAsserts {
    ...
    public static void assertTemplateUpdatableFieldsEquals(Template expected, Template actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getTituloMensagem()).as("check tituloMensagem").isEqualTo(expected.getTituloMensagem()))
            .satisfies(a -> assertThat(a.getCorpoMensagem()).as("check corpoMensagem").isEqualTo(expected.getCorpoMensagem()))
            .satisfies(a -> assertThat(a.getTipoMensagem()).as("check tipoMensagem").isEqualTo(expected.getTipoMensagem()));
    }
