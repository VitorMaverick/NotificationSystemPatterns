...
public class ClienteAsserts {
    ...
    public static void assertClienteUpdatableFieldsEquals(Cliente expected, Cliente actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSegmentoId()).as("check segmentoId").isEqualTo(expected.getSegmentoId()));
    }
    ...
    public static void assertClienteUpdatableRelationshipsEquals(Cliente expected, Cliente actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSegmento()).as("check segmento").isEqualTo(expected.getSegmento()));
    }
}
