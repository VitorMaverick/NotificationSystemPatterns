...
public class ClienteTestSamples {
    ...
    public static Cliente getClienteSample1() {
        return new Cliente().id(1L).nome("nome1").email("email1").telefone("telefone1").segmentoId(1L);
    }

    public static Cliente getClienteSample2() {
        return new Cliente().id(2L).nome("nome2").email("email2").telefone("telefone2").segmentoId(2L);
    }
    ...
    public static Cliente getClienteRandomSampleGenerator() {
        return new Cliente()
            ...
            .segmentoId(longCount.incrementAndGet());
    }
}
