...
import br.edu.acad.ifma.service.mapper.ClienteMapper;
...
class ClienteResourceIT {
    ...
    private static final Long DEFAULT_SEGMENTO_ID = 1L;
    private static final Long UPDATED_SEGMENTO_ID = 2L;
    ...
    public static Cliente createEntity() {
        return new Cliente().nome(DEFAULT_NOME).email(DEFAULT_EMAIL).telefone(DEFAULT_TELEFONE).segmentoId(DEFAULT_SEGMENTO_ID);
    }
    ...
    public static Cliente createUpdatedEntity() {
        return new Cliente().nome(UPDATED_NOME).email(UPDATED_EMAIL).telefone(UPDATED_TELEFONE).segmentoId(UPDATED_SEGMENTO_ID);
    }
    ...
    @Test
    @Transactional
    void checkSegmentoIdIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        cliente.setSegmentoId(null);
    ...
    void getAllClientes() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.[*].segmentoId").value(hasItem(DEFAULT_SEGMENTO_ID.intValue())));
    }
    ...
    void getCliente() throws Exception {
        ...
        restClienteMockMvc
            ...
            .andExpect(jsonPath("$.segmentoId").value(DEFAULT_SEGMENTO_ID.intValue()));
    }
    ...
    void putExistingCliente() throws Exception {
        ...
        updatedCliente.nome(UPDATED_NOME).email(UPDATED_EMAIL).telefone(UPDATED_TELEFONE).segmentoId(UPDATED_SEGMENTO_ID);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nome(UPDATED_NOME).email(UPDATED_EMAIL).telefone(UPDATED_TELEFONE).segmentoId(UPDATED_SEGMENTO_ID);
