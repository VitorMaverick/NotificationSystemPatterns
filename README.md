# Utilização de Padrões de Projeto na Implementação de Sistemas de Notificação Push

### Objetivo gerais 
- Construir um sistema de gerenciamento envio de mensagens push no navegador ou dispositivos móveis, que seja: flexível, reutilizável e escalável
- Explicar, através de trechos de codigo do sistema, quais vantagens e desvantagens do uso dos padrões adotados
- Integração com Firebase Cloud Messaging e Web Push

### Objetivos Técnicos
- Padrões de Projeto: Observer, Strategy, Builder
- Arquitetura escalável (microserviços, filas)
...
```
- **Funcionalidades:**
  - Envio de notificações (Android/Web)
  - Segmentação e personalização
  - Painel de controle para campanhas
  - Templates reutilizáveis de mensagens
  - Agendamento de envio
  - Coleta de métricas de desempenho
  - Gerenciamento de assinaturas e preferências

### Tecnologias
- Backend: Java 21, Spring Boot, JHipster
- Frontend: React
- Notificações: Firebase Cloud Messaging, Service Worker, Push API

### Comando utilizados na criação e configuração do projeto
```
docker run -it --rm -v "$PWD":/app -w /app jhipster/jhipster jhipster 
docker run -it --rm -v "$PWD":/app -w /app jhipster/jhipster jhipster import-jdl utilities/notification-manager-system.jdl
```
#### Parametros de criação do projeto
- What is the base name of your application? notificationSystem
- Which *type* of application would you like to create? Microservice application
- What is your default Java package name? br.edu.acad.ifma
- Would you like to use Maven or Gradle for building the backend? Maven
- Do you want to make it reactive with Spring WebFlux? No
- As you are running in a microservice architecture, on which port would like
  your server to run? It should be unique to avoid port conflicts. 8084
...
- Which *development* database would you like to use? PostgreSQL (requires
  Docker or manually configured database)
...
- Besides Jest/Vitest, which testing frameworks would you like to use? Cucumb
...
- Modelar diagramas de classe e de sequencia
- Implementação de protótipo dos principais  componentes visuais
...
To build the final jar and optimize the notificationSystem application for production, run:
